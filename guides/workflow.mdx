...
// Test authentication
const response = await fetch('https://api.orders.sdigital2.com/api/users', {
  headers,
})
...
# Test authentication
response = requests.get('https://api.orders.sdigital2.com/api/users', headers=headers)
...
const response = await fetch('https://api.orders.sdigital2.com/api/recipients', {
  method: 'POST',
  headers,
...
response = requests.post(
    'https://api.orders.sdigital2.com/api/recipients',
    headers=headers,
...
const response = await fetch(
  `https://api.orders.sdigital2.com/api/orders/${orderId}/confirm`,
  {
    method: 'PUT',
    headers,
...
response = requests.put(
    f'https://api.orders.sdigital2.com/api/orders/{order_id}/confirm',
    headers=headers,
    json=confirmation
)
